...
# TAV 20220815 - Need to filter out non-flask managed databases 
# See https://github.com/miguelgrinberg/Flask-Migrate/issues/438
bind_names = list(filter(lambda x: x not in ['mango','tincan'],bind_names))
#

for bind in bind_names:
    if bind in ['mango', 'tincan']:
        continue
